...
namespace labs
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            student.Information = new Person("Ivan", "Aks", new DateTime(2003, 08, 06));
            student.Formofstudy = Education.Specialist;
            student.NumberOfGroup = 13;
            student.getExams = new Exam[1] { new Exam("Math", 2, new DateTime(2022, 1, 3)) };
            Console.WriteLine(student.ToShortString());
            //Создание нового экзамена и добавление его и стандартного в список наших экзаменов
            Exam[] Exams = new Exam[1] { new Exam("Networks", 5, new DateTime(2022, 1, 4)) };
            student.AddExams(Exams[1]);
            student.AddExams(new Exam());
            ...
            var student0 = new Student(new Person("Artem", "Freyman", new DateTime(2003, 05, 21)), Education.Specialist, 165);
